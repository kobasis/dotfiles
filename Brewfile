...
mas install 1024640650 CotEditor (3.6.12)
...
mas install 890031187 Marked 2 (2.5.30)
mas install 1063631769 Medis (0.6.0)
mas install 1289197285 MindNode (5.2.3)
...
mas install 711830901 OmniGraffle (6.6.1)
mas install 1142578753 OmniGraffle (7.9.4)
mas install 1142578772 OmniOutliner (5.4.1)
mas install 1040002810 OmniPlan (3.10.4)
